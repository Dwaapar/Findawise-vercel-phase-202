...
import translationManagementRoutes from './admin/translation-management';
import culturalManagementRoutes from './admin/cultural-management';
import apiKeyManagementRoutes from './admin/api-key-management';

const router = Router();

// Mount translation management routes
router.use('/translation', translationManagementRoutes);

// Mount cultural management routes  
router.use('/cultural', culturalManagementRoutes);

// Mount API key management routes
router.use('/admin', apiKeyManagementRoutes);
