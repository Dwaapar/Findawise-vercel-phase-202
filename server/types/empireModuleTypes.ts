...
export const PageConfigSchema = z.object({
  ...
  customizations: z.object({
    allowedModules: z.array(ModuleTypeSchema).optional(),
    lockedSettings: z.array(z.string()).optional(),
...
export interface PageGenerationResponse {
  ...
  metadata: {
    ...
    cacheHit: boolean;
    security?: EmpireSecurityContext;
    performance?: EmpirePerformanceMetrics;
    seo?: {
      score: number;
      suggestions: string[];
    };
  ...
  validation?: EmpireValidationResult;
...
// Duplicate interfaces removed - definitions are above

// ===== ALL TYPES EXPORTED ABOVE =====
// All interfaces, types, and schemas are exported individually