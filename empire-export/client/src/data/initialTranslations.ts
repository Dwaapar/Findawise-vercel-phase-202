...
export const initialTranslationKeys = [
  ...
  // Complete Business & Finance Page Translations
  ...
  { keyPath: 'pages.investment.title', defaultValue: 'Smart Investment Portfolio Management', category: 'pages' },
  { keyPath: 'pages.investment.description', defaultValue: 'Advanced portfolio diversification strategies for long-term wealth accumulation and risk management.', category: 'pages' },
  { keyPath: 'pages.business.title', defaultValue: 'Scale Your Business Empire', category: 'pages' },
  { keyPath: 'pages.business.description', defaultValue: 'Enterprise-grade business scaling strategies and operational excellence frameworks.', category: 'pages' },
  { keyPath: 'pages.realestate.title', defaultValue: 'Real Estate Investment Mastery', category: 'pages' },
  { keyPath: 'pages.realestate.description', defaultValue: 'Professional real estate investment analysis and market intelligence systems.', category: 'pages' },
