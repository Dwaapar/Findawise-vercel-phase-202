        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full glass-vibrant border border-amber-500/30 enterprise-glow"
            >
              <Crown className="w-5 h-5 text-amber-400" />
              <span className="text-amber-200 font-semibold tracking-wide">Billion-Dollar Enterprise Platform</span>
            ...
            >
              <div className="text-center p-4 rounded-xl glass-light glow-primary">
                <div className="text-2xl font-bold text-blue-400">450+</div>
                <div className="text-sm text-gray-300 font-medium">Database Tables</div>
              </div>
              <div className="text-center p-4 rounded-xl glass-light glow-secondary">
                <div className="text-2xl font-bold text-purple-400">7+</div>
                <div className="text-sm text-gray-300 font-medium">AI Neurons</div>
              </div>
              <div className="text-center p-4 rounded-xl glass-light glow-accent">
            ...
            >
              <motion.button
                ...
                className="btn-primary btn-lg flex items-center justify-center gap-3 group bg-gradient-primary enterprise-glow"
              >
              ...
              <motion.button
                ...
                className="btn-outline btn-lg flex items-center justify-center gap-3 group glass-light"
              >
